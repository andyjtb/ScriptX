...
class InvalidateCacheOnDestroy : public jsi::HostObject {
 public:
  ...
  virtual jsi::Value get(jsi::Runtime &, const jsi::PropNameID &name) { return jsi::Value::null(); }
  virtual void set(jsi::Runtime &, const jsi::PropNameID &name, const jsi::Value &value) {}
  virtual std::vector<jsi::PropNameID> getPropertyNames(jsi::Runtime &rt) { return {}; }
